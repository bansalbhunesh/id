...
It includes live Render screenshots under `docs/deck/assets/`, current repository and product links, and 21-test verification evidence. The generated PDF is committed as `docs/deck/UdyamPulse-IDBI-Submission-Deck.pdf`.

...
It includes live-product screenshots under `docs/deck/assets/`, current repository and product links, calibrated champion-model evidence, and 50-test verification. The generated PDF is committed as `docs/deck/UdyamPulse-IDBI-Submission-Deck.pdf`; re-export it from the refreshed `index.html` whenever model evidence or screenshots change.
